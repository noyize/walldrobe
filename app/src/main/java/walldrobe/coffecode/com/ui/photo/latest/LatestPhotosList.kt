...
@Destination
@Composable
fun LatestPhotosScreen(
    viewModel: LatestPhotosViewModel = hiltViewModel(),
    navigator: DestinationsNavigator
) {

    val photos = viewModel.latestPhotosPaging.collectAsLazyPagingItems()
    ...
    Scaffold(
        ...
        PagedPhotosList(
            ...
            header = {
                Text(
                    text = stringResource(id = R.string.latest_photos_description),
